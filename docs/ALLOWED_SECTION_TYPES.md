...
Only the section components used on the home page are allowed. These live under `src/app/marketing-ai-studio/components/sections/` and are composed in `src/app/marketing-ai-studio/App.tsx`.

## Hero
- Path: `src/app/marketing-ai-studio/components/sections/Hero.tsx`
...
## ProblemSolution
- Path: `src/app/marketing-ai-studio/components/sections/ProblemSolution.tsx`
...
## Principle
- Path: `src/app/marketing-ai-studio/components/sections/Principle.tsx`
...
## ShipFast
- Path: `src/app/marketing-ai-studio/components/sections/ShipFast.tsx`
...
## Trust
- Path: `src/app/marketing-ai-studio/components/sections/Trust.tsx`
...
## SystemApply
- Path: `src/app/marketing-ai-studio/components/sections/SystemApply.tsx`
...
## FAQ
- Path: `src/app/marketing-ai-studio/components/sections/FAQ.tsx`
- Reuse: Accordion list with Reveal.
- Must not change: Accordion animation, card styling, and icon treatment.

## FinalCTA
- Path: `src/app/marketing-ai-studio/components/sections/FinalCTA.tsx`
