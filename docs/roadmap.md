...
deployment_status: VERIFIED — production /api/version matched 38bc212ad315d211812f4c4432b76afbf66a63e0 after PXF-018A deployment (security remediation: MailerLite credential removal, project API fail-closed, API security tests, CI secret scanning); all 8 canonical routes HTTP 200; Image: ghcr.io/prochattools/prochat:38bc212ad315d211812f4c4432b76afbf66a63e0; built 2026-08-05T14:03:48Z; CI: TypeScript ✓, ESLint ✓, secret-sources scan ✓, build ✓ 109 pages, browser evidence ✓, API security tests ✓ (11 tests passed), performance evidence collected (informational)
```
