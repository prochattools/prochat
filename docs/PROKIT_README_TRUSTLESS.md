...
# --- Stripe ---
STRIPE_SECRET_KEY_TEST=sk_test_XXXXXXX
STRIPE_SECRET_KEY_LIVE=sk_live_XXXXXXX
NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_TEST=pk_test_XXXXXXX
NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY_LIVE=pk_live_XXXXXXX
STRIPE_WEBHOOK_SECRET_TEST=whsec_test_XXXXXXX
STRIPE_WEBHOOK_SECRET_LIVE=whsec_live_XXXXXXX
