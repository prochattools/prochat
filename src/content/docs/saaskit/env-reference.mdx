...
What these do: keep both `true` to run without the shared auth UI; set both `false` to enable the shared auth UI.

- `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY`
- `CLERK_SECRET_KEY`

What these do: Ory and shared auth UI backend keys.  
Where to get them: your Ory / ProChat deployment settings.
