      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-md mx-auto">
            <div className="bg-[#111] rounded-2xl border border-white/10 dark:border-[#373C53] p-8 shadow-2xl relative overflow-hidden group hover:border-[#5b49f5]/50 transition-colors duration-500 transform-gpu">
                ...
                <Button href="/waiting-list" className="w-full bg-[#5b49f5] hover:bg-[#4a3bd1] border-0 h-14 text-lg font-bold shadow-lg shadow-[#5b49f5]/20 hover:shadow-[#5b49f5]/40 transition-all relative z-10">
                    Get SaaSKit
                </Button>
