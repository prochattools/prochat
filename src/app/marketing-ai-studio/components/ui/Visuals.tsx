...
export const FakeLogos = () => (
  <div className="flex gap-8 opacity-50 grayscale transition-all duration-500 hover:grayscale-0 hover:opacity-100 items-center justify-center dark:opacity-60">
    <div className="flex items-center gap-2 group cursor-default">
      <div className="w-4 h-4 bg-slate-800 rounded-sm group-hover:bg-[#5b49f5] transition-colors dark:bg-slate-300" />
    ...
    <div className="flex items-center gap-2 group cursor-default">
      <div className="w-4 h-4 rounded-full border-2 border-slate-800 group-hover:border-[#5b49f5] transition-colors dark:border-slate-300" />
    ...
    <div className="flex items-center gap-2 group cursor-default">
      <div className="w-4 h-4 bg-slate-800 rotate-45 rounded-sm group-hover:bg-[#5b49f5] transition-colors dark:bg-slate-300" />
    ...
    <div className="h-12 border-b border-slate-200 bg-white flex items-center px-5 justify-between shrink-0 z-10 dark:border-[#1E2A42] dark:bg-[#0F1626]">
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
                 ...
                 <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-indigo-500 to-purple-500 ring-2 ring-white shadow-sm ml-1 dark:ring-[#0F1424]" />
            </div>
        </div>
    </div>
    ...
    <div className="p-4 sm:p-5 flex-1 overflow-hidden flex flex-col gap-4">
        ...
        <div className="flex-1 flex items-end gap-1 sm:gap-2 pb-px border-b border-slate-200/60 border-dashed dark:border-[#1E2A42]/80">
            {[35, 55, 45, 70, 60, 85, 95, 75, 60, 80, 50, 65].map((h, i) => (
                <div key={i} className="flex-1 bg-[#5b49f5]/5 hover:bg-[#5b49f5] transition-all duration-300 rounded-t-sm relative group cursor-crosshair dark:bg-[#5b49f5]/20 dark:hover:bg-[#5b49f5]" style={{ height: `${h}%` }}>
        ...
        <div className="grid grid-cols-2 gap-3 h-20 shrink-0">
             ...
             <div className="bg-white rounded border border-slate-200 p-3 shadow-sm flex flex-col justify-between dark:bg-[#0F1626] dark:border-[#1E2A42] dark:shadow-none">
                <div className="w-7 h-7 rounded bg-blue-50 text-blue-500 border border-blue-100 flex items-center justify-center dark:bg-blue-500/10 dark:text-blue-300 dark:border-blue-400/20">
...
export const AuthMockup = () => (
  <div className="w-full h-full bg-white flex flex-col items-center justify-center p-6 sm:p-8 font-sans select-none relative dark:bg-[#0F1424]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(91,73,245,0.03),transparent_40%)] dark:bg-[radial-gradient(circle_at_top_right,rgba(91,73,245,0.12),transparent_45%)]" />
      ...
      <div className="w-full space-y-3 relative z-10">
          <div className="space-y-1.5">
              ...
              <div className="h-9 w-full bg-white border border-slate-200 focus:border-[#5b49f5] rounded-lg flex items-center px-3 text-[11px] text-slate-800 shadow-sm transition-colors dark:bg-[#0B111B] dark:border-[#1E2A42] dark:text-slate-100 dark:shadow-none">
                  steve@example.com
              </div>
          </div>
          <div className="space-y-1.5">
          ...
          <div className="h-9 w-full bg-slate-900 hover:bg-slate-800 transition-colors rounded-lg flex items-center justify-center text-white text-[11px] font-bold mt-2 shadow-md cursor-default dark:bg-[#5b49f5] dark:hover:bg-[#4a3bd1] dark:text-white dark:shadow-none">
              Sign In
          </div>
...
export const BillingMockup = () => (
    <div className="w-full h-full bg-slate-50/50 p-6 font-sans select-none flex flex-col relative dark:bg-[#0C121F]">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm mb-4 relative z-10 group hover:border-[#5b49f5]/30 transition-colors dark:bg-[#0F1626] dark:border-[#1E2A42] dark:shadow-none dark:hover:border-[#5b49f5]/40">
            ...
            <div className="mt-2.5 flex justify-between items-center">
                ...
                <div className="text-[9px] text-[#5b49f5] font-bold cursor-default hover:underline dark:text-[#9b8bff]">Manage</div>
            </div>
        </div>
...
export const EmailMockup = () => (
    <div className="w-full h-full bg-white flex flex-col font-sans select-none dark:bg-[#0F1424]">
        ...
        <div className="p-5 flex-1 flex flex-col items-center text-center pt-8">
             ...
             <div>
                 <div className="px-4 py-1.5 bg-[#5b49f5] rounded-md text-white text-[9px] font-bold shadow-md shadow-indigo-500/20 dark:shadow-none">
                     Confirm Email
                 </div>
             </div>
        </div>
