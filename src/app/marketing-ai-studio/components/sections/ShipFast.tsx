...
export const ShipFast: React.FC = () => {
  return (
    <section id="system" className="py-32 relative bg-white border-b border-slate-100 dark:bg-[#0B111B] dark:border-[#1E242D]">
      <div className="max-w-5xl mx-auto px-8">
        
        <div className="text-center mb-24">
            <Reveal>
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">The ProChat loop</h2>
            </Reveal>
            <Reveal delay={0.3}>
              <p className="text-slate-500 mt-2 font-light dark:text-slate-400">The operational sequence for extracting software from service.</p>
            </Reveal>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative mb-16">
             ...
             <div className="hidden lg:block absolute top-10 left-[12%] right-[12%] h-px bg-slate-200 dark:bg-[#2A3445]" />
