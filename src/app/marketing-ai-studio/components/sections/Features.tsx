        ...
        <div className="max-w-7xl mx-auto px-6 mb-20">
            ...
            <Reveal delay={0.3}>
              <p className="text-slate-500 mt-4 max-w-2xl font-light">
                  The system demands speed. To achieve it, we eliminated architectural decisions by standardizing the four core pillars of every SaaS.
              </p>
            </Reveal>
            <Reveal delay={0.4}>
              <div className="mt-8">
                <Link href="/kits/prokit" className="text-[#5b49f5] font-bold hover:underline inline-flex items-center gap-2">
                  View infrastructure map <ArrowRight size={16} />
                </Link>
              </div>
            </Reveal>
        </div>
