...
const FAQS = [
    ...
    { 
        q: "Why ProKit vs other boilerplates?", 
        a: "We prioritize code quality and design. Most boilerplates look generic. ProKit is designed to look like a $50k agency build out of the box. We also include a real documentation site, not just a README." 
    },
    { 
