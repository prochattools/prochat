...
const Testimonial = () => {
  return (
    <section
      className="relative isolate overflow-hidden px-8 py-24 sm:py-32"
      id="testimonials"
    >
      <div className="absolute inset-0 -z-10 bg-black opacity-20" />
      <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-black shadow-lg ring-1 ring-base-content/10 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
      <div className="mx-auto max-w-2xl lg:max-w-5xl">
        <figure className="mt-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div>
              <blockquote className="text-xl font-medium leading-8 text-white sm:text-2xl sm:leading-10">
                I just used ProKit, and having Stripe checkout plus user
                authentication wired up already is a lifesaver. This will save
                me about a week of work for each new side project I start. I
                also appreciate how well-documented it is. Definitely worth it!
              </blockquote>
              ...
              <figcaption className="mt-10 flex items-center justify-start gap-5">
                <div className="text-base">
                  ...
                  <div className="text-white">Indie Maker &amp; Developer</div>
                </div>
