...
export function DiscordIcon({ className = 'h-4 w-4 shrink-0 fill-current' }: SocialIconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function GithubIcon({ className = 'h-4 w-4 shrink-0 fill-current' }: SocialIconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
