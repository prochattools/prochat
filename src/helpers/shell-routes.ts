...
export const SHELL_ROUTE_DEFINITIONS: readonly ShellRouteDefinition[] = [
  ...
  { routeId: 'ROUTE-007', sourcePattern: '/docs', runtimePattern: '/docs', shellClass: 'no_shared_shell' },
  { routeId: 'ROUTE-008', sourcePattern: '/docs/[category]/[[...slug]]', runtimePattern: '/docs/[category]/[[...slug]]', shellClass: 'no_shared_shell' },
  ...
  { routeId: 'ROUTE-035', sourcePattern: '/learn', runtimePattern: '/learn', shellClass: 'temporary_legacy_compatibility' },
  { routeId: 'ROUTE-036', sourcePattern: '/learn/production-guide', runtimePattern: '/learn/production-guide', shellClass: 'temporary_legacy_compatibility' },
  { routeId: 'ROUTE-037', sourcePattern: '/learn/saas-starting-point', runtimePattern: '/learn/saas-starting-point', shellClass: 'temporary_legacy_compatibility' },
