...
export const faqData = [
  {
    ...
    answer: [
      "ProKit is a one-time purchase with lifetime access to the ProChat GitHub repo.",
      "You keep ownership of the code you ship with it.",
      "Includes TypeScript App Router code, Prisma migrations, scripts, docs, and community access.",
    ],
  },
  {
    question: "What do I get?",
    answer: [
      "A Next.js 14 starter with auth, billing, SEO blog, dashboard, UI components, Docker, and automation hooks.",
    ],
  },
  {
    question: "My tech stack is different, can I still use it?",
    answer: [
      "ProKit is optimized for Next.js, TypeScript, Tailwind/shadcn/ui, Clerk, Prisma/Postgres, Stripe, Resend, and n8n. Sticking to this stack gives the best DX.",
    ],
  },
  {
    question: "I do not know how to code. Can I use it?",
    answer: [
      "Follow the step-by-step docs and video guides; setup is scripted so you can get running with minimal coding.",
    ],
  },
  {
    question: "Is it a template?",
    answer: [
      "It’s more than a template—it includes scripts, infra docs, production patterns, and ready-to-ship flows.",
    ],
  },
  {
    question: "Why is ProKit better than other starters?",
    answer: [
      "Provision/migrate/cleanup scripts, preview tenants, billing/auth prewired, and a builder community to keep you moving fast.",
    ],
  },
  {
    question: "Are there any hidden costs?",
    answer: [
      "Vendor fees still apply (Stripe, Clerk seats, Resend emails, hosting Postgres/Dokploy). ProKit itself is a one-time license.",
    ],
  },
  {
    question: "Can I get a refund?",
    answer: [
      "Access is delivered instantly after purchase; reach out if you hit issues and we’ll help unblock you.",
    ],
  },
  {
    question: "How often is ProKit updated?",
    answer: [
      "We track Next.js, Prisma, Clerk, and Stripe releases and roll out updates regularly.",
    ],
  },
];
