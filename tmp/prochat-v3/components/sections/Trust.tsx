  ...
  return (
    <section className="py-24 bg-slate-50 border-b border-slate-200">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <Reveal>
            <h2 className="text-3xl font-bold text-slate-900 mb-8">Methodology over magic.</h2>
        </Reveal>
        ...
        <Reveal delay={0.3}>
            <ul className="space-y-4 mb-10 text-left max-w-lg mx-auto">
                {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-slate-600 font-light text-lg">
