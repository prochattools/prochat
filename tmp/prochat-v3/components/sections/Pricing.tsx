...
export const Pricing: React.FC = () => {
  return (
    <section id="pricing" className="py-32 bg-[#0a0a0a] relative overflow-hidden text-white">
      {/* Dark Blueprint Grid */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20 space-y-4">
            ...
            <div className="flex items-center justify-center gap-6 text-slate-400 font-light text-sm md:text-base">
        ...
        <div className="max-w-md mx-auto">
            <div className="bg-[#111] rounded-2xl border border-white/10 p-8 shadow-2xl relative overflow-hidden group hover:border-[#5b49f5]/50 transition-colors duration-500 transform-gpu">
                ...
                <div className="mb-8 text-center relative z-10">
                    ...
                    <div className="flex items-baseline justify-center gap-3">
                        ...
                        <span className="text-slate-500 line-through text-xl">$347</span>
                    </div>
                    <p className="text-slate-500 text-sm mt-4 font-light">Pay once. Build forever.</p>
                </div>
                ...
                <p className="text-center text-xs text-slate-600 mt-6 flex items-center justify-center gap-2 relative z-10">
